                        ...
                        <section class="toplead-height px-5 mx-n5" data-simplebar style="height: 395px;">
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Socrates Itumay"
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Angelina Hose"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Selena Deoyl"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Charlie Davieson"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Leo Phillip"
                                        class="rounded-circle me-2" width="40" height="40">
                                    <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="border p-4 rounded" data-simplebar style="height: 182px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="David Wilson"
                                        class="rounded avatar-md">
                                    <div>
