                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush list-borderless">
                            <li class="list-group-item d-flex justify-content-between py-3">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Instructor"
                            ...
                            <li class="list-group-item d-flex justify-content-between py-3">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Instructor"
                                        class="avatar-md rounded-circle">
                                    <div>
                            ...
                            <li class="list-group-item d-flex justify-content-between py-3">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Instructor"
                                        class="avatar-md rounded-circle">
                                    <div>
                            ...
                            <li class="list-group-item d-flex justify-content-between pt-3 pb-0">
                                <div class="d-flex gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Instructor"
                                        class="avatar-md rounded-circle">
                                    <div>
