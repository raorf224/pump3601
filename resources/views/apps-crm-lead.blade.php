                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start gap-3">
                            <div
                                class="flex-shrink-0 h-40px w-40px bg-success-subtle d-flex justify-content-center align-items-center rounded-pill text-success fs-4">
                                <i class="bi bi-list-ul"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h2>76</h2>
                                <h6 class="fw-medium mb-0">Total Invoice</h6>
                                <p class="pt-4 mb-0 text-muted">Lead this month<span
                                        class="badge bg-success-subtle text-success ms-1"><i
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start gap-3">
                            <div
                                class="flex-shrink-0 h-40px w-40px bg-primary-subtle d-flex justify-content-center align-items-center rounded-pill text-primary fs-4">
                                <i class="bi bi-door-open"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h2>102</h2>
                                <h6 class="fw-medium mb-0">Open</h6>
                                <p class="pt-4 mb-0 text-muted">Lead this month<span
                                        class="badge bg-success-subtle text-success ms-1"><i
                                            class="bi bi-arrow-up"></i>1.5%</span></p>
                            </div>
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start gap-3">
                            <div
                                class="flex-shrink-0 h-40px w-40px bg-danger-subtle d-flex justify-content-center align-items-center rounded-pill text-danger fs-4">
                                <i class="bi bi-x-octagon"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h2>51</h2>
                                <h6 class="fw-medium mb-0">Closed</h6>
                                <p class="pt-4 mb-0 text-muted">Lead this month<span
                                        class="badge bg-danger-subtle text-danger ms-1"><i
            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start gap-3">
                            <div
                                class="flex-shrink-0 h-40px w-40px bg-secondary-subtle d-flex justify-content-center align-items-center rounded-pill text-secondary fs-4">
                                <i class="bi bi-currency-dollar"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h2>88</h2>
                                <h6 class="fw-medium mb-0">Annual Profit</h6>
                                <p class="pt-4 mb-0 text-muted">Lead this month<span
                                        class="badge bg-success-subtle text-success ms-1"><i
                                            class="bi bi-arrow-up"></i>1.5%</span></p>
                            </div>
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                            <h6 class="card-title mb-0 fw-semibold">
                                Lead <span class="badge bg-secondary-subtle text-secondary ms-1">28</span>
                            </h6>
                            ...
                            <table class="table text-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-light-subtle text-body">Closed</span></td>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="contactStatus" class="form-label">Lead Status</label>
