...
function calculateNetReceived() {
    ...
    if (netReceived <= 0) {
        ...
        $('#saveReceive').on('click', function () {
            ...
            const shiftId = $('#receiveShiftId').val();
...
if (Math.abs(totalTankShortage - topLevelShortage) > 0.01) {
    ...
    return;
            ...
            // ✅ REMOVED: Remaining validation that checks if distribution matches netReceived
            // Allow over-distribution or under-distribution
            ...
            const processImageAndSend = (imageBase64 = null) => {
                ...
                if (imageBase64) {
                    postData.invoice_image = imageBase64;
                }
