                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table align-middle">
                            <tbody>
                                <tr>
                                    <td class="w-50px"><img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Avatar Image"
                                ...
                                <tr>
                                    <td class="w-50px"><img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Avatar Image"
                                            class="avatar-md rounded"></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w-50px"><img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avatar Image"
                                            class="avatar-md rounded"></td>
                                    <td>
