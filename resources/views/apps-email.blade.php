                ...
                <div class="message-list-content" data-simplebar>
                    <ul class="message-list" id="mail-list">
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-4.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-8.jpg') }}"
                                    alt="avatar image">
                            </div>
                        ...
                        <li
                            ...
                            <div class="avatar-item avatar-md">
                                <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}"
                                    alt="avatar image">
                            </div>
                ...
                <div class="mail-preview">
                    <div class="mail-header">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="avatar-md me-2 rounded-circle"
                                alt="Sender Avatar">
                            <div>
