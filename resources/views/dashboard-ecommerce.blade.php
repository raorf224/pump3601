                            ...
                            <table class="table text-nowrap table-hover align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/flag/us.svg') }}" alt="Flag Image" class="w-30px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/flag/de.svg') }}" alt="Flag Image" class="w-30px">
                    ...
                    <div class="card-body">
                        <section class="px-5 mx-n5" data-simplebar style="height: 360px;">
                            <div class="d-flex align-items-start mb-6">
                                <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" class="avatar-md rounded-circle me-3"
                                    alt="User">
                            ...
                            <div class="d-flex align-items-start mb-6">
                                <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" class="avatar-md rounded-circle me-3"
                                    alt="User">
                                <div class="flex-grow-1">
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('assets/images/product/img-01.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('assets/images/product/img-02.png') }}"
                                                    class="avatar-lg border rounded-1 p-1" alt="Product Iamge">
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="assets/"{{ asset('assets/images/product/img-03.png') }}"
                                                    class="avatar-lg border rounded-1 p-1" alt="Product Iamge">
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('assets/images/product/img-04.png') }}"
                                                    class="avatar-lg border rounded-1 p-1" alt="Product Iamge">
                                                <div>
