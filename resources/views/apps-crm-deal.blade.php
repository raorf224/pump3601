                        ...
                        <div id="b1">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Dax Zeno</h6>
                        ...
                        <div id="b2">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                        ...
                        <div id="b4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Acme Corp</h6>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Acme Corp</h6>
                        ...
                        <div id="b5">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-3 my-5">
                                        <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Zara Lume"
                                            class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Acme Corp</h6>
