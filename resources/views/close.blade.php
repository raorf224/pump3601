                                        ...
                                        <div class="col-md-12">
                                            <div class="card border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <label class="form-label required-label">Total Transfer
                                                                Amount</label>
        ...
        <input type="hidden" class="nozzle-image-data" 
            ...
            function validateNozzleImages() {
                ...
                $('.nozzle-reading-row').each(function () {
                    ...
                    // If closing reading is entered, image is required
                    if (closingReading && closingReading.trim() !== '') {
                        if (!imageData || imageData === '') {
                            isValid = false;
                            $(`#nozzle_image_${nozzleId}`).addClass('is-invalid');
                            showToast(`Nozzle image is required when closing reading is entered!`, 'error');
                        } else {
            ...
            function collectNozzleImageData() {
                const imageData = [];

                $('.nozzle-reading-row').each(function () {
                    const nozzleId = $(this).data('nozzle-id');
                    const imageBase64 = $(`#nozzle_image_data_${nozzleId}`).val();
                    const closingReading = $(this).find('.nozzle-closing').val();

                    if (imageBase64 && imageBase64 !== '' && closingReading && closingReading.trim() !== '') {
                        imageData.push({
                            nozzle_id: nozzleId,
                            image: imageBase64
                        });
            ...
            // Before sending to server, compress large images
            ...
            $("#save_close_shift,#save_close_shift1").on("click", function () {
                ...
                // ✅ ✅ ✅ MOVE THESE TO THE TOP - BEFORE ANYTHING ELSE
                const promises = [];
                const savedItems = [];
                ...
                // Save nozzle readings with images
