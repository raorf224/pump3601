...
<head>
    ...
    <style>
        ...
        /* Print styles - fallback for small PDF */
        @media print {
            ...
            <div class="company-header">
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        ...
                        <p class="mb-0 mt-2"><small>Report ID: SHIFT-{{ $shift->id }}</small></p>
                        ...
                        <div class="row g-4 text-center mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="summary-card">
                                            <h6 class="text-primary mb-0">Rs. {{ number_format($cashFlow->fuelcard ?? 0, 2) }}
                                            </h6>
                                    ...
                                    <div class="col-6">
                                        <div class="summary-card">
                                            <h6 class="text-info mb-0">Rs. {{ number_format($cashFlow->creditcard ?? 0, 2) }}
                                            </h6>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <div class="summary-card text-center">
                                    <h5 class="text-warning">Rs. {{ number_format($financialSummary['cash_handover'] ?? 0, 2) }}
                                    </h5>
                            ...
                            <div class="col-md-3">
                                <div class="summary-card text-center">
                                    <h5 class="text-primary">Rs. {{ number_format($financialSummary['cash_in_hand'] ?? 0, 2) }}
                                    </h5>
                            ...
                            <div class="col-md-3">
                                <div class="summary-card text-center">
                                    <h5 class="text-dark">Rs. {{ number_format($financialSummary['cash_in_bank'] ?? 0, 2) }}
                                    </h5>
                            ...
                            <div class="col-md-3">
                                <div class="summary-card text-center">
                                    <h5 class="text-success">Rs.
                                        {{ number_format($financialSummary['total_cash_balance'] ?? 0, 2) }}</h5>
    ...
    <script>
        document.getElementById('downloadPdfBtn')?.addEventListener('click', async function () {
            ...
            try {
                ...
                // OPTIMIZED: Lower scale = smaller file size
                const canvas = await html2canvas(element, {
                    scale: 1.2,  // Reduced from 2.5 to 1.2 for smaller file size
                ...
                // OPTIMIZED: Compress image quality
                ...
                btn.disabled = false;
                btn.innerText = '📄 Download PDF (Small)';
            }
        });
    </script>
