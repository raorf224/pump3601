                    ...
                    <tbody>
                        @foreach($tankCalculations as $calculation)
                            <tr>
                                ...
                                <td class="text-end {{ abs($calculation['variance_percent']) <= 0.5 ? 'text-success' : (abs($calculation['variance_percent']) <= 1.0 ? 'text-warning' : 'text-danger') }}">
                                    ...
                                    <div class="summary-card">
                                        ...
                                        <table class="table table-sm table-bordered">
                                            ...
                                            @if($calculation['oil_purchased'] > 0)
                                                <tr>
                                                    <td>Oil Purchased:</td>
                                                    <td class="text-end text-info">+{{ number_format($calculation['oil_purchased'], 2) }}</td>
                                                </tr>
                                            @endif
                                            <tr>
                                    ...
                                    <div class="summary-card">
                                        ...
                                        <table class="table table-sm table-bordered">
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($calculation['nozzle_sales_liters'], 2) }} L</td>
                                            </tr>
                                            <tr>
                                                <td>Reset Sales (Liters):</td>
                                                <td class="text-end">{{ number_format($calculation['reset_sales_liters'], 2) }} L</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Total Nozzle Sales:</strong></td>
                                                <td class="text-end"><strong>{{ number_format($calculation['total_nozzle_sales'], 2) }} L</strong></td>
                                            </tr>
                ...
                <div class="summary-card h-100 p-4 border rounded bg-white">
                    ...
                    <div class="small text-start">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <strong>Rs. {{ number_format($financialSummary['transaction_income'] ?? 0, 2) }}</strong>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="summary-card h-100 p-4 border rounded bg-white">
                    ...
                    <div class="small text-start">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <strong>Rs. {{ number_format($financialSummary['transaction_expense'] ?? 0, 2) }}</strong>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="summary-card">
                        ...
                        <table class="table table-sm table-bordered">
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($lubeSummary['purchase']['total_qty'], 2) }} Units</td>
                            </tr>
                            <tr>
                                <td>Total Amount:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['purchase']['total_amount'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Cash Paid:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['purchase']['cash_paid'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Bank Paid:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['purchase']['bank_paid'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Card Paid:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['purchase']['card_paid'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>On Credit/Not Paid:</td>
                                <td class="text-end text-warning">Rs. {{ number_format($lubeSummary['purchase']['credit'], 2) }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="summary-card">
                        ...
                        <table class="table table-sm table-bordered">
                            <tr>
                                <td>Total Quantity:</td>
                                <td class="text-end">{{ number_format($lubeSummary['sale']['total_qty'], 2) }} Units</td>
                            </tr>
                            <tr>
                                <td>Total Amount:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['sale']['total_amount'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Cash Received:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['sale']['cash_received'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Bank Received:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['sale']['bank_received'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>Card Received:</td>
                                <td class="text-end">Rs. {{ number_format($lubeSummary['sale']['card_received'], 2) }}</td>
                            </tr>
                            <tr>
                                <td>On Credit/Not Paid:</td>
                                <td class="text-end text-warning">Rs. {{ number_format($lubeSummary['sale']['credit'], 2) }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach($lubeDocuments as $doc)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $doc->payment_status == 'paid' ? 'success' : ($doc->payment_status == 'partial' ? 'warning' : 'danger') }}">
                            ...
                            <div class="col-md-12">
                                <div class="summary-card">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tr>
                                            <td>Total Amount:</td>
                                            <td class="text-end text-danger">Rs. {{ number_format($oilPurchaseSummary['total_amount'], 2) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        @if($oilPurchaseSummary['cash_paid'] > 0)
                                            <tr>
                                                <td>Cash Paid:</td>
                                                <td class="text-end">Rs. {{ number_format($oilPurchaseSummary['cash_paid'], 2) }}</td>
                                            </tr>
                                        @endif
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-3">
                                <div class="summary-card p-3 border rounded bg-white text-center">
                                    <h4 class="text-warning fw-bold mb-2">{{ number_format($totalShortageLiters, 2) }} <small class="fs-6">L</small></h4>
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    @foreach($shiftShortagePayments as $index => $payment)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $payment->recive_date ? \Carbon\Carbon::parse($payment->recive_date)->format('M d, Y') : 'N/A' }}</td>
                                            <td class="text-end text-warning fw-bold">{{ number_format($payment->total_shortage ?? 0, 2) }} L</td>
                                            <td class="text-end text-success fw-bold">Rs. {{ number_format($payment->total_amount ?? 0, 2) }}</td>
                                ...
                                <tfoot class="table-warning">
                                    <tr>
                                        ...
                                        <td class="text-end"><strong>{{ number_format($totalShortageLiters, 2) }} L</strong></td>
                                        <td class="text-end"><strong>Rs. {{ number_format($totalShortagePaid, 2) }}</strong></td>
                            ...
                            <div class="col-md-6">
                                <div class="summary-card">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        <tr>
                                            <td>Total Income:</td>
                                            <td class="text-end text-success">Rs. {{ number_format($financialSummary['transaction_summary']['income']['total'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Cash Received:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['income']['cash'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Bank Received:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['income']['bank'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Card Received:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['income']['card'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>On Credit:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['income']['credit'], 2) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="summary-card">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        <tr>
                                            <td>Total Expense:</td>
                                            <td class="text-end text-danger">Rs. {{ number_format($financialSummary['transaction_summary']['expense']['total'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Cash Paid:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['expense']['cash'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Bank Paid:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['expense']['bank'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Card Paid:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['expense']['card'], 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>On Credit:</td>
                                            <td class="text-end">Rs. {{ number_format($financialSummary['transaction_summary']['expense']['credit'], 2) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    @foreach($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-{{ $transaction->method == 'cash' ? 'success' : ($transaction->method == 'bank' ? 'info' : 'warning') }}">
                                ...
                                <tfoot>
                                    <tr class="table-info">
                                        ...
                                        <td class="text-end"><strong>Rs. {{ number_format($financialSummary['transaction_summary']['expense']['total'], 2) }}</strong></td>
                                        <td class="text-end"><strong>Rs. {{ number_format($financialSummary['transaction_summary']['income']['total'], 2) }}</strong></td>
                                        <td colspan="2" class="{{ $financialSummary['transaction_net'] >= 0 ? 'text-success' : 'text-danger' }}">
                                            <strong>Net: Rs. {{ number_format($financialSummary['transaction_net'], 2) }}</strong>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
