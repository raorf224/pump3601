            ...
            <div class="company-header">
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        <div class="no-print">
                             <a href="{{ route('shift.export.excel', $shift->id) }}" class="btn btn-success">
                                    📊 Download Excel Report
                                  </a>
                            <a href="{{ route('shift.download.pdf', $shift->id) }}" class="btn btn-primary">
                                📄 Generate PDF Report
                            </a>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    @if($calculation['physical_usage'] > 0)
                                                        +{{ number_format($calculation['physical_usage'], 2) }}
                                                    @elseif($calculation['physical_usage'] < 0) {{
                                                    number_format($calculation['physical_usage'], 2) }} @else 0.00 @endif
                                                </td>
                                            </tr>
                            ...
                            <div class="col-md-6">
                                <div class="summary-card">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tr>
                                            <td>Total Amount:</td>
                                            <td class="text-end">Rs. {{ number_format(
                    $lubeSummary['purchase']['total_amount'],
                    2
                ) }}</td>
                                        </tr>
                                        <tr>
